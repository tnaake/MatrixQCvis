...
urthermore, the `shiny` application allows for simple differential 
...
samples per sample type, treatment, etc. 
...
balanced manner:
```{r mosaic, eval=TRUE, echo=FALSE, dev = "png", dpi = 42}
...
```{r hist_feature_missing, eval=FALSE, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r hist_feature_category, eval=FALSE, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r upsetmeasured, eval=TRUE, echo=FALSE, dev = "png", dpi = 42}
...
```{r upsetmissing, eval=TRUE, echo=FALSE, dev = "png", dpi = 42}
...
```{r boxplot, eval=TRUE, echo=FALSE, warning=FALSE, dev = "png", dpi = 42}
...
```{r drift, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, dev = "png", dpi = 42}
...
```{r cv, eval=TRUE, echo=FALSE, warning=FALSE, message=FALSE, dev = "png", dpi = 42}
a <- assay(se)
se_t <- se
a_n <- a %>% normalize(., "sum")
...
```{r meansdplot, eval=TRUE, echo=FALSE, warning=FALSE, dev = "png", dpi = 42}
...
```{r maplot, eval=TRUE, show=FALSE, dev = "png", dpi = 42}
...
```{r ecdf, eval=TRUE, echo=FALSE, dev = "png", dpi = 42}
...
```{r distSampe, eval=TRUE, echo=FALSE, dev = "png", dpi = 42}
a <- assay(se)
...
```{r featurePlot, eval=TRUE, echo=FALSE, dev = "png", dpi = 42}
