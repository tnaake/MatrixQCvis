...
```{r samples_memi, eval=TRUE, echo=FALSE, crop=NULL}
tbl <- samples_memi(se) 
...
```{r hist_feature_measured, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, crop=NULL}
...
```{r hist_feature_missing, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, crop=NULL}
...
```{r hist_feature_category, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, crop=NULL}
