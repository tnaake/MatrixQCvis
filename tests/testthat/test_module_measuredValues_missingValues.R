...
#     testServer(barplotMeMiSampleServer, {
#     
#         input <- new.env()
#         output <- new.env()
#         session <- new.env()
...
#     testServer(histFeatCategoryServer, {
#         input <- new.env()
#         output <- new.env()
#         session <- new.env()
#         id <- new.env()
